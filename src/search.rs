...
impl<'a> Searcher<'a> {
    ...
    fn corrected_static_eval(&self, board: &Board, raw: i32) -> i32 {
        ...
        // NAO amortecer aqui pelo relogio dos 50: `amortece_rule50` ja' o faz,
        // e ja' fazia antes (ver as chamadas no `negamax` e na quiescencia).
        // Acrescentei uma segunda amortizacao por cima da primeira sem dar por
        // ela -- procurei por `fifty_scale`/`escala_50`/`regra_50` e nao pelo
        // nome que tem. Medido: 7628 jogos, -1.8 +/- 4.0 Elo. Amortecer duas
        // vezes nao amortece melhor.
