...
template<>
struct std::hash<Kestrel::Eval::NNUE::NetworkArchitecture> {
    Kestrel::usize
    operator()(const Kestrel::Eval::NNUE::NetworkArchitecture& arch) const noexcept {
