...
class Position {
   ...
   private:
    ...
    // Acrescentado por este projecto (ver nnue_vendor/README.md): a avaliacao
    // desta arquitectura le' informacao de ameaca que a posicao mantem, e quem
    // monta a posicao pondo pecas precisa de a mandar recompor. So' expoe o que
    // ja' existe; nao muda nada do que faz.
    void repoe_estado() const { set_state(); }
